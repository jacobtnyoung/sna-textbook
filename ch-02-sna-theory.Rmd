...
As discussed in LINK TO LECTURE 1, network science takes **relational structures** as the primary domain of interest. In so doing, research questions take the following forms:
...
![](../sna-textbook/images/ch-02-table-01.jpeg)
