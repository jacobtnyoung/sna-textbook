...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-10-graph-07.jpeg" )
```
...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-10-graph-08.jpeg" )
```
...
In this chapter we:  
  ...
  * Introduced the structure of bipartite graphs (also called two-mode networks).
  
  * Discussed how bipartite graphs are represented in matrix form.
  
  * Analyzed the properties of bipartite graphs.
  
<br>

#### Continue to [Chapter 11: Projection](ch-11-projection.html)
