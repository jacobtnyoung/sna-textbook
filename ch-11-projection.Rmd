...
knitr::opts_chunk$set( echo = FALSE, eval = TRUE, message=FALSE, warning=FALSE, fig.width = 10 )
library( here )
```
...
Let's revisit an empirical question from the [introduction](https://jacobtnyoung.github.io/sna-textbook/ch-01-intro-to-sna.html) to the course and that we reviewed in the chapter on [bipartite graphs](https://jacobtnyoung.github.io/sna-textbook/ch-10-bipartite-graphs.html). [Young & Ready (2015)](https://journals.sagepub.com/doi/10.1177/1043986214553380) examined two research questions:
...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-11-figure-01.jpeg" )
```
...
As we saw in the chapter on [bipartite graphs](https://jacobtnyoung.github.io/sna-textbook/ch-10-bipartite-graphs.html), networks with complex node sets can be represented using an adjacency matrix and analyzed in various ways. However, a common approach in research is to reduce a bipartite graph to a unipartite graph so as to use the tools developed for networks with a single set of nodes. **Projection** is the process by which we map the connectivity between modes to a single mode.
...
We can see this graphically by taking a look at our example network from the chapter on [bipartite graphs](https://jacobtnyoung.github.io/sna-textbook/ch-10-bipartite-graphs.html):
...
The product matrix is the projected graph. Recall that there are two potential product matrices we can create:
  ...
  * $A \times A^T$ (what [Breiger (1974)](https://doi.org/10.1093/sf/53.2.181) called the “people” matrix, $P$) and
  * The $A^T \times A$ (what [Breiger (1974)](https://doi.org/10.1093/sf/53.2.181) called the “group” matrix $G$)
...
Here is a question. *What network measure does the diagonal give us?* Think back to the chapter on [bipartite graphs](https://jacobtnyoung.github.io/sna-textbook/ch-10-bipartite-graphs.html).
...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-11-figure-17.jpeg" )
```
...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-11-figure-18.jpeg" )
```
...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-11-figure-19.jpeg" )
```
...
#### Continue to [Chapter 12: Weighted Graphs](ch-12-weighted-graphs.html)
