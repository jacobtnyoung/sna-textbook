...
When we say a *node* is "central", what do we mean conceptually? To help, let's start with some applications.


### Popularity during Adolescence

In a classic paper entitled [Adolescence-Limited and Life-Course Persistent Antisocial Behavior: A Developmental Taxonomy](), [Terrie Moffitt](https://moffittcaspi.trinity.duke.edu/about/moffitt) proposed a hypothesis to explain an long known fact about crime and antisocial behavior. Specifically, Moffitt sought to answer the question: why is there a dramatic increase in delinquency during adolescence? 

```{r, fig.cap = "", out.width = "60%", fig.align="center"}
knitr::include_graphics( "images/ch-05-moffitt-01.jpeg" )
```

Multiple studies (and the figure above) show that delinquency increases substantially during the teen years and declines rapidly during early adulthood. *Why*?

According to Moffitt's [*Dual-Taxonomy Theory*]() there are two types of individuals who engage in delinquency. First, there are **life-course persistent** individuals who (as the name implies) persistently engage in antisocial behavior throughout their lives: they are difficult children, problematic teens, and troublesome partners as adults. Then, there are **adolescence limited** individuals who only engage in antisocial behavior during adolescence. Since their offending is limited to this period, this is why we see a spike during adolescence. As the figure below shows:

```{r, fig.cap = "", out.width = "60%", fig.align="center"}
knitr::include_graphics( "images/ch-05-moffitt-02.jpeg" )
```

Why do these **adolescence limited** individuals engage in antisocial behavior and then stop? According to the theory, these individuals seek to gain status during adolescence. Since the typical routes to status are restricted until adulthood, they look to the behavior of **life-course persistent** youth. They mimic this behavior (e.g. drinking alcohol, using drugs, vandalizing property) until they essentially age-out as they enter the labor market or higher education.

*What does this have to do with centrality?* A key mechanism of Moffitt's theory is that **adolescence limited** youth will become more popular during adolescence. Essentially, Moffitt argues that these individuals will not be popular when they are young, will increase in popularity during adolescence, and then decline in popularity as everyone else enters young adulthood. 

```{r, fig.cap = "", out.width = "40%", fig.align="center"}
knitr::include_graphics( "images/ch-05-moffitt-03.jpeg" )
```

This hypothesis was first tested in the article [“Role Magnets”? An Empirical Investigation of Popularity Trajectories for Life-Course Persistent Individuals During Adolescence](https://link.springer.com/article/10.1007/s10964-013-9946-0) by [Jacob Young](https://jacobtnyoung.github.io/) (yes, that is me). Specifically, the goal of the study was to examine the developmental trajectory of popularity during adolescence for individuals showing persistent violence into young adulthood. 

```{r, fig.cap = "", out.width = "40%", fig.align="center"}
knitr::include_graphics( "images/ch-05-moffitt-04.jpeg" )
```

The study found that chronically violent individuals showed a more precipitous increase in centrality during adolescence. Overall, the findings were consistent with Moffitt's hypothesis. 

<br>

### Disrupting Hate Speech Online

Let's consider another example. As has been noted by many concerned citizens and scholars, hate speech in online forums has become a salient issue. If you are an organization who hosts such sites, what can you do to reduce hate speech? One approach is to "deplatform" particular individuals. This approach is a type of *strategic network disruption* whereby select individuals are removed from the network with the goal of reducing hate speech among those who are still using the platform. The logic is that these individuals are critical links that connect others and their absence will reduce hateful content. Does it work?
...
knitr::include_graphics( "images/ch-05-thomas-01.jpeg" )
```
...
knitr::include_graphics( "images/ch-05-matrix-01.jpeg" )
```
...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-05-matrix-02.jpeg" )
```
...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-05-matrix-03.jpeg" )
```
...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-05-matrix-04.jpeg" )
```
...
```{r, fig.cap = "", out.width = "60%"}
knitr::include_graphics( "images/ch-05-matrix-05.jpeg" )
```
...
The indegree centralization score, $C_I$, is 0.438 and the outdegree centralization score, $C_O$, is 0.125. *What does the difference tell us?*
...
#### Continue to [Chapter 6: Closeness Centrality](ch-06-centrality-closeness.html)
